...
//		@Pattern(regexp = "^[a-zA-Z0-9]+$", message = "The username must contain only letters and numbers") String username,

		@NotEmpty @Size(min = 3, max = 20, message = "The email must be between 10 and 30 characters") String email,

		@NotEmpty(message = "The password cannot be empty") @Size(min = 8, max = 16, message = "The password must be between 8 and 16 characters") String password,
